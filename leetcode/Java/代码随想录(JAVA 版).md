...
5. [55. 右旋字符串——补充题目](leetcode\Java\55.右旋字符串（补充题目）.java)
6. [28. 找出字符串中第一个匹配项的下标](leetcode\Java\28.找出字符串中第一个匹配项的下标.java)
7. [459. 重复的子字符串](leetcode\Java\459.重复的子字符串.java)

### 双指针法

1. [27. 移除元素（同「数组」第二题）](leetcode\Java\27.移除元素.java)
2. [344. 反转字符串（同「字符串」第一题）](leetcode\Java\344.反转字符串.java)
3. [54. 替换数字——补充题目（同「字符串」第三题）](leetcode\Java\54.替换数字（补充题目）.java)
4. [151. 反转字符串中的单词（同「字符串」第四题）](leetcode\Java\151.反转字符串中的单词.java)
5. [206. 反转链表（同「链表」第三题）](leetcode\Java\206.反转链表.java)
6. [19. 删除链表的倒数第-n-个结点（同「链表」第五题）](leetcode\Java\19.删除链表的倒数第-n-个结点.java)
7. [160. 相交链表（同「链表」第六题）](leetcode\Java\160.相交链表.java)
8. [142. 环形链表-ii（同「链表」第七题）](leetcode\Java\142.环形链表-ii.java)
9. [15. 三数之和（同「哈希表」第七题）](leetcode\Java\15.三数之和.java)
10. [18. 四数之和（同「哈希表」第八题）](leetcode\Java\18.四数之和.java)
...
4. [1047. 删除字符串中的所有相邻重复项](leetcode\Java\1047.删除字符串中的所有相邻重复项.java)
5. [150. 逆波兰表达式求值](leetcode\Java\150.逆波兰表达式求值.java)
6. [239. 滑动窗口最大值](leetcode\Java\239.滑动窗口最大值.java)
7. [347. 前-k-个高频元素](leetcode\Java\347.前-k-个高频元素.java)

### 二叉树

1. [144. 二叉树的前序遍历](leetcode\Java\144.二叉树的前序遍历.java)
